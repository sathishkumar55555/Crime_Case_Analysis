...
export default function InsertSuspectForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://127.0.0.1:8000/insert-suspect', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className='border-solid border-green-500 border-2 p-8 rounded-md mt-12 ml-44 w-[600px] text-green-500 mb-10'>
            <h1 className='ml-[120px] mb-12 text-3xl bold'>Insert Suspect Data</h1>
            <form className='ml-10' onSubmit={handleSubmit}>
                ...
                <div className='mt-3'>
                    ...
                    className='bg-black border-2 border-green-500 rounded-lg ml-[59px] w-[200px] px-4'
                    />
                </div>
                <div className='mt-3'>
                    ...
                    className='bg-black border-2 border-green-500 rounded-lg ml-[97px] w-[200px] px-4'
                    />
                </div>
